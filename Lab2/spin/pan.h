...
#define _nstates5	42	/* pay_slope */
#define minseq5	107
#define maxseq5	147
#define _endstate5	41

#define _nstates4	11	/* all_slope */
#define minseq4	97
#define maxseq4	106
#define _endstate4	10

#define _nstates3	22	/* :init: */
#define minseq3	76
#define maxseq3	96
#define _endstate3	21

#define _nstates2	22	/* new_queue_gen */
#define minseq2	55
#define maxseq2	75
#define _endstate2	21

#define _nstates1	30	/* queueAction */
#define minseq1	26
#define maxseq1	54
#define _endstate1	29

#define _nstates0	27	/* decksAction */
#define minseq0	0
#define maxseq0	25
...
#define Pnew_queue_gen	((P2 *)this)
typedef struct P2 { /* new_queue_gen */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Air2	(sizeof(P2) - Offsetof(P2, man_id) - 1*sizeof(int))

#define PqueueAction	((P1 *)this)
typedef struct P1 { /* queueAction */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define PdecksAction	((P0 *)this)
typedef struct P0 { /* decksAction */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, man_id) - 1*sizeof(int))
